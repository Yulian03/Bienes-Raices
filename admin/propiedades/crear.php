    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST" action="/bienesraices/admin/propiedades/crear.php" enctype="multipart/form-data">
            <fieldset>
                ...
                <input type="texto" id="titulo" name="titulo" placeholder="Titulo Propiedad" value="<?php echo $titulo; ?>">
            ...
            <fieldset>
                ...
                <select name="vendedor_id">
                    ...
                    <?php while ($vendedor_id = mysqli_fetch_assoc($resultado)): ?>
                        <option <?php echo $vendedor_id === $vendedor_id['id'] ? 'selected' : ''; ?> value="<?php echo $vendedor_id['id']; ?>">
                        <?php echo $vendedor_id['nombre'] . " " . $vendedor_id['apellido']; ?> </option>
